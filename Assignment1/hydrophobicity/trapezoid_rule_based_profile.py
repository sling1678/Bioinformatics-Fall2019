...
"""
Trapezoid rule is a more sophisticated implementation of the sliding window technique for calculating the hydrophobicity
...
"""
Takes in amino acid and returns only the string with transmembrane regions.
...
Returns:
  result : list of 'x' meaning undecided, 'M' definitely inside membrane, 'P' putatively inside membrane
"""
def analyze_sequence(aa_sequence):
